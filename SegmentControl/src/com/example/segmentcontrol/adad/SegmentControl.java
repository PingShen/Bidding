...
public class SegmentControl extends LinearLayout {
	...
	public SegmentControl(Context context, AttributeSet attrs) {
		...
		layoutMarginsParams = new LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
	...
	public SegmentControl(Context context, int style) {
		...
		this.setOrientation(HORIZONTAL);
		currentStyle = style;
		layoutMarginsParams = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		layoutMarginsParams.setMargins(marginsLeft, 0, 0, 0);
	...
	/**
	 * 废弃 请使用setOnSegmentChangedListener代替
	 * 
	 * @param index
	 * @param l
	 */
