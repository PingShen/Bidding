...
public class TitleMessageBarLayout extends RelativeLayout{
	...
	public void setPushBean(PushBean bean){
		...
		configTag(tag);
		Log.e("dfdfdfdfd", "message:"+message+",tag:"+tag+",orderId:"+orderId);
	}
	...
	private void configTag(int tag) {
		...
		case ORDERRESULT:
			...
			Log.e("ashenashen", "status:"+status);
				...
				//
					...
					if(isDefaultHandle){
						...
						case SYS_NOTI:
							...
							map2.put("type", TABLE_OTHER.SYSNOTIF);
							ActivityUtils.goToActivityWithInteger(
									getContext(),
									OtherDetailActivity.class, map2);
							break;
						case NETWORK_ERROR:
