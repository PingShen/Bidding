...
public abstract class ZBBaseAdapter<T> extends BaseAdapter{
	...
	public void refreshSuccess(List<T> beans){
		this.beans = beans;
		Log.e("asadffrf","refresh size:"+this.beans.size());
		listener.onAdapterRefreshSuccess();
		
	}
	
	public void loadMoreSuccess(List<T> beans){
		Log.e("asadffrf","before load more size:"+this.beans.size());
		Log.e("asadffrf","beans size:"+beans.size());
		this.beans=beans;
		Log.e("asadffrf","load more size:"+this.beans.size());
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		//Log.e("uiuiui", "size:"+this.beans.size());
